    ...
    <PageBackground>
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <section className="mb-16 opacity-0 animate-fade-in-delay-1">
          ...
          <div className="mb-12 bg-design-cream/20 backdrop-blur-sm border border-design-lilac/30 rounded-lg overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-6">
                ...
                {!showReferralForm ? (
                  ...
                  <div className="bg-design-cream/30 p-4 rounded-md border border-design-lilac/20">
                    ...
                    <form onSubmit={handleReferralSubmit} className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input 
                            ...
                            required
                            className="w-full px-3 py-2 border border-design-lilac/30 rounded"
                          />
                        </div>
                        <div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <Button 
                          ...
                          variant="outline"
                          className="border-design-lilac/30 text-brx-dark hover:bg-brx-dark/10">
                          Cancel
                        </Button>
                      </div>
                    </form>
          ...
          {/* VIP Club Section */}
          <div className="mb-12 bg-design-cream/20 backdrop-blur-sm border border-design-lilac/30 rounded-lg overflow-hidden p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <input 
                ...
                className="px-4 py-2 border border-design-lilac/30 rounded"
              />
              <input 
                type="email" 
