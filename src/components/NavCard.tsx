...
const NavCard: React.FC<NavCardProps> = ({
  ...
  return (
    <Link
      to={href}
      className={`block p-4 sm:p-6 ${className} w-full text-center bg-white/85 backdrop-blur-sm border border-gray-200 rounded-2xl hover:bg-white/95 hover:border-gray-300 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-black/10`}
    >
